...
export default function ClozeScreen() {
  ...
  const howItWorksSteps = [
    "Read the sentence with the missing word (shown as _____)",
    "Say or write the missing word via the mic/keyboard buttons (or click on the card to reveal the answer).",
  ...
  const handlePlayAudio = async (text: string, language: string, tags?: string[]) => {
    ...
    try {
      ...
      fileUri = FileSystem.documentDirectory + "temp_audio.mp3";
